  ...
  return (
    <>
        <div className="card">
                <div className="card-body">
                  <div className="d-flex flex-column align-items-center text-center">
                    ...
                    <div className="mt-3">
                      ...
                      <button onClick={handleGetOrder} className="btn btn-primary">Đổi Mật Khẩu</button>
              ...
              <ModalResetPass showModal={showModal}  closeModal={closeModal} />

    </>
  )
}

function ModalResetPass({showModal,closeModal}){
  return (
    <ModalBootstrap
    ...
    >
      <ModalBootstrap.Header closeButton>
        <ModalBootstrap.Title>Đổi Mật Khẩu</ModalBootstrap.Title>
